...
export class MemberApi {
    ...
    public accountinfo(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'member/accountinfo';
        var headers = ApiConfig.GetHeader(url, data);
        let options = new RequestOptions({ headers: headers });
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/accountinfo', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/accountinfo', data, err);
            });
    }
    ...
    public addcutcount(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/addcutcount', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/addcutcount', data, err);
            });
    }
    ...
    public areacodelist(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'member/areacodelist';
        var headers = ApiConfig.GetHeader(url, data);
        let options = new RequestOptions({ headers: headers });
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/areacodelist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/areacodelist', data, err);
            });
    }
    ...
    public buyrecordlist(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/buyrecordlist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public checkpws(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'member/checkpws';
        var headers = ApiConfig.GetHeader(url, data);
        let options = new RequestOptions({ headers: headers });
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/checkpws', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/checkpws', data, err);
            });
    }


    public checkscanlogin(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'member/checkscanlogin';
        var headers = ApiConfig.GetHeader(url, data);
        let options = new RequestOptions({ headers: headers });
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/checkscanlogin', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/checkscanlogin', data, err);
            });
    }
    ...
    public cutlist(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/cutlist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/cutlist', data, err);
            });
    }
    ...
    public genscanlogin(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'member/genscanlogin';
        var headers = ApiConfig.GetHeader(url, data);
        let options = new RequestOptions({ headers: headers });
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/genscanlogin', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/genscanlogin', data, err);
            });
    }
    ...
    public rechargelist(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'member/rechargelist';
        var headers = ApiConfig.GetHeader(url, data);
        let options = new RequestOptions({ headers: headers });
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/rechargelist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/rechargelist', data, err);
            });
    }
    ...
    public setstatus(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'member/setstatus';
        var headers = ApiConfig.GetHeader(url, data);
        let options = new RequestOptions({ headers: headers });
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/setstatus', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/setstatus', data, err);
            });
    }
    ...
    public updateloginqrcode(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'member/updateloginqrcode';
        var headers = ApiConfig.GetHeader(url, data);
        let options = new RequestOptions({ headers: headers });
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/updateloginqrcode', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/updateloginqrcode', data, err);
            });
    }


    public updates(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'member/updates';
        var headers = ApiConfig.GetHeader(url, data);
        let options = new RequestOptions({ headers: headers });
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/updates', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/updates', data, err);
            });
    }
    ...
    public allocationrecordlist(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'member/allocationrecordlist';
        var headers = ApiConfig.GetHeader(url, data);
        let options = new RequestOptions({ headers: headers });
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/allocationrecordlist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/allocationrecordlist', data, err);
            });
    }
